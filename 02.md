...
1. On the **Azure Database for PostgreSQL Flexible Server** page, select **Migration (1)** and click on **+ Migration from Single Server (2)**.
...
2. On the **Setup** page, follow the below instructions:
 ...
 4. Under the **Target** tab, follow the below-mentioned instructions:
    ...
    ![](Images/postgreSQL-target.png)
        
5. Review the configuration and click on **Review + create**.
    
    ![](Images/postgreSQL-review.png)
