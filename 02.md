# Exercise -2 : Migating the database using offline method

   In this exercise you will be migrating the database from Single PostgreSQL server to Flexible PostgreSQL Server using the new Migration (Preview) tool.
