...
1. Wait for 1-2 minutes until the firewall rules gets updated and you may need to enter your server password to connect to cloud shell.
...
1. Navigate back to Azure Portal where you conected to Bash and run the below command to see the migrated tables from Single postgres server.
...
1. Run the below command to see the migrated roles from Single postgres server.
...
1. You can also create new roles by following the below given steps: 
   ...
   - Running the below mentioned command and save the file.
   ...
   - Navigate back to the command-promt and run the below command:
